...
export class ConsumerPatternComponent {
  private fb = inject(FormBuilder);

  public consumerPatternForm: FormGroup = this.fb.group({
  ...
  isValidField(field: string): boolean {
    return Boolean(this.consumerPatternForm.controls[field].errors) && this.consumerPatternForm.controls[field].touched;
  }

  getFormData() {
    return this.consumerPatternForm.value;
  }
}
